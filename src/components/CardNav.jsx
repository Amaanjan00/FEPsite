    ...
    <div
      ...
      <nav
        ...
        <div
          ...
          <button
            type="button"
            className="card-nav-cta-button hidden items-center justify-center md:inline-flex border-0 rounded-[calc(0.75rem-0.2rem)] px-4 h-full font-medium cursor-pointer transition-colors duration-300"
